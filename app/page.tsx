...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <DynamicContactForm location="India" domain="bulksafa.com" />
      <GallerySection />
      <DynamicServicesSection location="India" domain="bulksafa.com" />
      <DynamicFooter location="India" domain="bulksafa.com" />
      <WhatsAppFloat />
    </main>
  )
}
